    ...
    <div class="modal" onkeydown="if(event.ctrlKey && event.key === 'Enter') { event.preventDefault(); submitBatchFeed(); }" style="width: 980px; height: 85vh; max-height: 750px; display: flex; flex-direction: column;">
        <div class="modal-header" style="flex-shrink: 0; margin-bottom: 10px;">
            <div style="display: flex; align-items: center;">
                ...
                <span class="config-info" style="margin-left: 10px; font-weight: normal;">支持 Enter 键快速换行</span>
            </div>
        ...
        <div style="display: flex; flex: 1; overflow: hidden; gap: 20px;">
            ...
            <div style="flex: 1; display: flex; flex-direction: column; overflow: hidden; background: white; border-left: 1px dashed #FFEEE4; padding-left: 15px;">
                <div style="flex-shrink: 0; display: flex; align-items: center; gap: 12px; padding-bottom: 12px; margin-bottom: 10px; border-bottom: 2px solid #FFF3E0; flex-wrap: wrap;">
                ...
                <div class="batch-list-container" style="flex: 1; margin-bottom: 0; border: 1px solid #FFEEE4; overflow-x: hidden; max-height: none;">
                    <table class="data-table" style="width: 100%; table-layout: fixed;">
                        <thead style="position: sticky; top: 0; z-index: 10;">
                            <tr>
                                <th style="width: 25%;">姓名</th>
                                <th style="width: 20%;">可用积分</th>
                                <th style="width: 25%;">本次分值</th>
                                <th style="width: 30%;">兑换预览</th>
                            </tr>
                        </thead>
